...
window.AMPLER_CLIENTS = [
...

    {
        ...
        icon: './images/m-logo5.png',
        path: 'mc/eaglerforge/index.html',
        bundled: false
    },
    {
        id: 'resentclient',
        ...
        title: 'Resent Client',
        version: '1.8.8 - not bundled',
        icon: './images/m-logo4.png',
        path: 'mc/resentclient/index.html',
        bundled: false
    },
    {
        id: 'shadowclient',
        ...
        title: 'Shadow Client',
        version: '1.8.8 - not bundled',
        icon: './images/m-logo3.png',
        path: 'mc/shadowclient/index.html',
        bundled: false
    },
    {
        id: 'starlikeclient',
        ...
        title: 'Starlike',
        version: '1.8.8 - not bundled',
        icon: './images/m-logo6.png',
        path: 'mc/starlikeclient/index.html',
        bundled: false
    },
    {
        id: 'astraclient',
        ...
        title: 'Astra Client',
        version: '1.8.8 - not bundled',
        icon: './images/m-logo7.png',
        path: 'mc/astraclient/index.html',
        bundled: false
    },
...

    {
        ...
        version: '1.8.8 - not bundled',
        icon: './images/m-logo10.png',
        path: 'mc/flameddogo-mobile/index.html',
        bundled: false
    },
    {
        id: 'red-mobile',
        ...
        version: '1.8.8 - not bundled',
        icon: './images/m-logo9.png',
        path: 'mc/red-mobile/index.html',
        bundled: false
    },
    {
        id: 'red-controller',
        ...
        version: '1.8.8 - not bundled',
        icon: './images/m-logo8.png',
        path: 'mc/red-controller/index.html',
        bundled: false
    }
];
...
window.AMPLER_CATEGORIES = {
    web: {
        ...
        background: './images/web-edition.jpg',
        logo: './images/web-title.png',
        tab: 'gtabs2'
    },
    modded: {
        heading: 'EAGLERCRAFT MODDED',
        background: './images/modded-edition.jpg',
        logo: './images/modded-title.png',
        tab: 'gtabs3'
    },
    mobile: {
        heading: 'EAGLERCRAFT MOBILE/CONTROLLER',
        background: './images/controls-edition.jpg',
        logo: './images/controls-title.png',
        tab: 'gtabs4'
    }
};
